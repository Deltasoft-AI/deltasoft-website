import ShowcaseArticle from "../components/ShowcaseArticle";
...
<div className="relative isolate px-6 pt-14 lg:px-8">
    ...
    <div className="mx-auto max-w-5xl px-6 lg:px-0">
      <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
        ...
        <img className="shadow-xl rounded-xl object-cover w-full h-46" src="https://images.unsplash.com/photo-1525824617522-ca036119a052?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80" />
        <br />  
        <div className="flex items-center gap-x-4 text-xs">
          ...
          <div className="relative mt-8 flex items-center gap-x-4">
            <img src="https://i.ibb.co/0hLcRd7/JSman225-Profile-Photo.png" alt="" className="h-10 w-10 rounded-full bg-gray-50 shadow-2xl" />
